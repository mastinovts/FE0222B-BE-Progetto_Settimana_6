...
<body>
<% 
	ContoCorrente conto = (ContoCorrente)session.getAttribute("prelievoSession");
%>

	<div class="container text-center w-50 h-auto bg-light my-5 p-5">
		<div>
			<h5 class="text-success text-center">Operazione effettuata!</h5>
			<h3 class="text-lg-start">INTESTATARIO</h3>
			<p class="text-lg-start"><%=conto.getIntestatario()%></p>
			<h3 class="text-lg-start">CC Num.</h3>
			<p class="text-lg-start"><%=conto.getNumero()%></p>
			<h2 class="text-success">NUOVO SALDO DISPONIBILE</h2>
			<p><%=conto.getSaldo()%> &euro;</p>
